            ...
            <div className="card signup__card">
              <div className="card-body">
                <h1 className="card-title">
                  Get your budget in shape with Bulga!
                </h1>
                <form onSubmit={onSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      class={classNames("form-control", {
                        "is-invalid": error?.errorsFor?.("firstName"),
                      })}
                      id="firstName"
                      name="firstName"
                      onChange={onChange}
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      type="text"
                      class={classNames("form-control", {
                        "is-invalid": error?.errorsFor?.("lastName"),
                      })}
                      id="lastName"
                      name="lastName"
                      onChange={onChange}
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      type="text"
                      class={classNames("form-control", {
                        "is-invalid": error?.errorsFor?.("email"),
                      })}
                      id="email"
                      name="email"
                      onChange={onChange}
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      type="password"
                      class={classNames("form-control", {
                        "is-invalid": error?.errorsFor?.("password"),
                      })}
                      id="password"
                      name="password"
                      onChange={onChange}
                  ...
                  <div className="mb-3 text-center">
                    <Link className="greenBtn" to="/login">
